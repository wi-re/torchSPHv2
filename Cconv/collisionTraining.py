...
def constructFluidFeatures(attributes, inputData):
    ...
    difference = inputData['fluidPosition'] - torch.tensor([0,0], dtype = inputData['fluidPosition'].dtype, device = inputData['fluidPosition'].device)
    ...
    accel = -0.5 * 10**2 * difference * (distance)[:,None]**2
