...
parser.add_argument('--cutlassBatchSize', type=int, default=256)
...
def processBatchCached(bdata, unrollSteps : int, dataCache : torch.Tensor, attributes, model, optimizer, dataSet, augmentAngle = False, augmentJitter = False, jitterAmount = 0.01):
    ...
    optimizer.step()
    return stackedLosses.detach().cpu().numpy()
