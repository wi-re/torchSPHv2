...
@torch.jit.script 
def computeRenormalizedDensityGradient(i, j, ri, rj, Vi, Vj, distances, radialDistances, support, numParticles : int, eps : float, Li, Lj, rhoi, rhoj, grad):
    gradW = kernelGradient(radialDistances, distances, support)
